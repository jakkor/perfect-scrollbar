...
function bindMouseDragHandler(i) {
   ...
   */
  var positionChecker$$1 = new positionChecker(borderOffset);
  ...
  element.addEventListener(
    ...
    function(e) {
      ...
      if (positionChecker$$1.isNearTopBorder(e, element)) {
        newScrollDirection = 'top';
      } else if (positionChecker$$1.isNearBottomBorder(e, element)) {
